...
public class RobotMap {
	...
	public static final int SCALE_BUTTON = 5;
	...
	public static final int LAUNCHER_ARMS_UP = 4;
	public static final int LAUNCHER_ARMS_DOWN = 1;

	public static final int RAMPS_SOLENOID_EXPAND_BUTTON = 7;
	public static final int RAMPS_SOLENOID_RETRACT_BUTTON = 8;
	public static final int TRANSMISSION_SOLENOID_EXPAND_BUTTON = 6;
